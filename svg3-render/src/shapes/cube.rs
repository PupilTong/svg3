...
//! single uniform [`Element::fill`](svg3_dom::Element) colour today, the
...
//! — see [`crate::shapes`]. `transform` and grouping are not applied yet,
//! matching the rest of [`crate::scene::build_scene`].
